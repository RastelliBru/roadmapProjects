# Front end projects from [roadmap.sh](#https://roadmap.sh/frontend/projects)
...
## Basic HTML Website
![Basic HTML Website](/Frontend/basic-html-website/assets/Capturarresult-website.PNG)
## Show the code:
- [Code Single-Page CV](https://github.com/RastelliBru/roadmapProjects/blob/main/Frontend/single-page-cv/index.html)
- [Basic HTML Website](https://github.com/RastelliBru/roadmapProjects/tree/main/Frontend/basic-html-websitel)